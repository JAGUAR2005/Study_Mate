...
- [ ] Working StudyMate AI build is deployed and free to test.
...
- [ ] Codex use is described in the written submission.
- [ ] GPT-5.6 use is demonstrated in the product and video.
- [ ] Key product, engineering, and design decisions are documented.
- [ ] New work and timestamps are clear if any pre-event documentation existed.
- [ ] Primary build thread `/feedback` Codex Session ID is recorded.

## Demo

- [ ] Public YouTube link.
- [ ] Demo link: `PASTE_PUBLIC_YOUTUBE_URL_HERE`
- [ ] Video is under three minutes and has clear audio.
- [ ] Video shows the problem, the end-to-end workflow, and the role of Codex/GPT-5.6.
- [ ] No unlicensed music, copyrighted material, private data, or exposed credentials.

## Final verification

- [ ] Clean-checkout setup completed.
- [ ] Critical smoke test passed.
- [ ] Known limitations are disclosed.
- [ ] Final repository, deployment, screenshots, and video describe the same build.
...
- Primary build-thread `/feedback` Codex Session ID: `PASTE_SESSION_ID_HERE`
